...
spritebuilder::CCBAnimationManager *CoreCCBLayer::getAnimationManager()
{
...
// TODO SpriteBuilderの名前検索は、まだ未実装なので正しくデータを取得できません。2014/6/27 Hiramatsu
/**
 * 名前から対象となるNodeを検索
 */
cocos2d::Node* CoreCCBLayer::getUIItemByName(const std::string& name, Node* startWidget, bool isRecursive)
{
    if (_layoutFormat != LayoutFormat_SpriteBuilder)
    {
