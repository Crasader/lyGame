...
static __TYPE__* createWithSpriteBuilderFile(std::string __PATH__, cocos2d::Ref* __OWNER__, const cocos2d::Size __BOUNDS__, void* __PARAMS__ = nullptr) \
{ \
...
public:
    ...
    virtual bool initWithSpriteBuilderFile(std::string& formatFile, cocos2d::Ref* owner=nullptr, const cocos2d::Size rectSize=cocos2d::Size(0, 0), void* params = nullptr);
