...
//    frameCache->addSpriteFramesWithFile("common/questUINum.plist");
...
{
//    SpriteFrameCache* frameCache = SpriteFrameCache::getInstance();
//    frameCache->removeSpriteFramesFromFile("common/questUINum.plist");
}
...
// 指定したシーンIDまでスタックを削除してchangeSceneする
...
void ApplicationManager::setSceneManager(ISceneManager* sceneMgr)
{
    _sceneMgr = sceneMgr;
}

ISceneManager* ApplicationManager::getSceneManager() const
{
    return _sceneMgr;
}
