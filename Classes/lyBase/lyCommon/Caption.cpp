...
void Caption::onEnter()
{
    ...
    if (this->getUserObject() != nullptr) {
        // アニメーションマネージャー設定
        _animationManager = (spritebuilder::CCBAnimationManager *)this->getUserObject();
...
bool Caption::onAssignCCBMemberVariable(Ref *pTarget, const char *pMemberVariableName, Node *pNode) {
    SB_MEMBERVARIABLEASSIGNER_GLUE(this, "backButton", cocos2d::extension::ControlButton *, _backButton);
    SB_MEMBERVARIABLEASSIGNER_GLUE(this, "captionName", cocos2d::Label *, _captionName);
    SB_MEMBERVARIABLEASSIGNER_GLUE(this, "backButtonTxt", cocos2d::Label *, _backButtonTxt);
    SB_MEMBERVARIABLEASSIGNER_GLUE(this, "captionTitleImg", cocos2d::Sprite *, _captionTitleImg);
