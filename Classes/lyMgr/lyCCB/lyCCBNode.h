...
#ifndef __lyGame__lyCCBNode__
#define __lyGame__lyCCBNode__
...
class lyCCBNode   :   public cocos2d::Node,
...
CREATE_CCB_LOADER_CLASS(lyCCBNode, lyCCBNodeLoader);


#endif /* defined(__lyGame__lyCCBNode__) */
