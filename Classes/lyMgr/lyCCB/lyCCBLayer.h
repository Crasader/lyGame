...
#ifndef __lyGame__lyCCBLayer__
#define __lyGame__lyCCBLayer__
...
class lyCCBLayer    : public CoreLayer,
...
CREATE_CCB_LOADER_CLASS(lyCCBLayer, lyCCBLayerLoader);
