...
#include "extensions//GUI/CCEditBox/EditBoxFilteredOpenTouch.h"
...
namespace spritebuilder {
    ...
    class ExtTextField : public EditBoxFilteredOpenTouch {
    ...
    public:
        ...
        virtual void editBoxEditingDidBegin(cocos2d::extension::EditBox* editBox) {
            EditBoxFilteredOpenTouch::editBoxEditingDidBegin(editBox);
        }
        virtual void editBoxEditingDidEnd(cocos2d::extension::EditBox* editBox) {
            EditBoxFilteredOpenTouch::editBoxEditingDidEnd(editBox);
        }
        virtual void editBoxTextChanged(cocos2d::extension::EditBox* editBox, const std::string& text) {
            EditBoxFilteredOpenTouch::editBoxTextChanged(editBox, text);
        }
        virtual void editBoxReturn(cocos2d::extension::EditBox* editBox) {
            EditBoxFilteredOpenTouch::editBoxReturn(editBox);
...
void EditBoxLoader::onHandlePropTypeSize(Node * pNode, Node * pParent, const char* pPropertyName, Size pSize, CCBReader * ccbReader) {
    if(strcmp(pPropertyName, PROPERTY_PREFERREDSIZE) == 0) {
        ...
        ((EditBox*)pNode)->setContentSize(pSize);
