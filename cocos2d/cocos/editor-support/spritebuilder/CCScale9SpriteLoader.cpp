...
#define PROPERTY_INSETLEFT "marginLeft"
#define PROPERTY_INSETTOP "marginTop"
#define PROPERTY_INSETRIGHT "marginRight"
#define PROPERTY_INSETBOTTOM "marginBottom"
...
void Scale9SpriteLoader::onDone(cocos2d::Node * pNode, cocos2d::Node * pParent, CCBReader * ccbReader) {
    ...
    Size size = _spriteFrame->getOriginalSize();
